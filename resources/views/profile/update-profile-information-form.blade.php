<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-input label="{{ __('Name') }}" id="name" type="text" class="block w-full mt-1" wire:model.defer="state.name" autocomplete="name" />
            <x-input-error for="name" class="mt-2" />
        </div>

        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <x-input label="{{ __('Email') }}" id="email" type="email" class="block w-full mt-1" wire:model.defer="state.email" autocomplete="username" />
    ...
    <x-slot name="actions">
        ...
        <x-button type="submit" primary wire:loading.attr="disabled" wire:target="photo" label="{{ __('Save') }}"/>
    </x-slot>
</x-form-section>
