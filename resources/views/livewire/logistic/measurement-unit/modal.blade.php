<x-modal.card title="{{ $measurementUnitId ? 'Editar' : 'Registrar' }} Unidad de Medida" blur wire:model.defer="open">
    ...
    <x-slot name="footer">
    <div class="flex justify-{{$measurementUnitId ? 'between' : 'end'}} gap-x-4">
